...
const tiers = [
  ...
  },
  {
    ...
    features: [
      ...
      "Mulimedia support in chats (coming soon)",
          ...
          >
            <div>
              <h3
                ...
                className="text-base font-semibold leadin-7 text-indigo-600"
              >
                {tier.name}
              </h3>
              <div className="mt-4 flex items-baseline gap-x-2">
                {tier.priceMonthly ? (
                  <>
                    <span className="text-5xl font-bold trcking0tight text-gray-900">
                      {tier.priceMonthly}
                    </span>
